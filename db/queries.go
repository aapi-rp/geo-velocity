...
const GetSubsequent = `select * from GEO_VELOCITY_EVENTS WHERE LOGIN_TIME > ? ORDER BY LOGIN_TIME ASC LIMIT 1`
const GetPrevious = `select * from GEO_VELOCITY_EVENTS WHERE LOGIN_TIME < ? ORDER BY LOGIN_TIME DESC LIMIT 1`
